      ...
      <main className="pt-16">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                ...
                <span className="text-gradient">From MVP to Scale</span>
              </motion.h1>
              ...
              >
                We build complete SaaS applications with user authentication, payment integration, admin dashboards, and everything you need to launch and scale your business.
              </motion.p>
        ...
        <section className="py-20 bg-white dark:bg-gray-950">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold mb-8">Micro SaaS Development</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
              Starting at ₹1,25,000 - Complete SaaS products from MVP to scale with authentication, payments, admin dashboards, and everything needed for production.
            </p>
          </div>
        </section>
      </main>
