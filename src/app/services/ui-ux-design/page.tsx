      ...
      <main className="pt-16">
        <section className="py-20 bg-gradient-to-br from-ryx-white via-ryx-silver/20 to-ryx-gold/10 dark:from-ryx-navy dark:via-ryx-navy-light/20 dark:to-ryx-navy-dark/40">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                Intuitive, Beautiful Interfaces That{" "}
                <span className="text-gradient">Keep Users Engaged</span>
              </motion.h1>
              ...
              >
                We design digital products that are not only beautiful but also easy to use, turning visitors into customers and customers into loyal fans.
              </motion.p>
        ...
        <section className="py-20 bg-white dark:bg-gray-950">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold mb-8">UI/UX Design Services</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
              Starting at ₹35,000 - Full content coming soon with user research, wireframes, prototypes, and design systems.
            </p>
          </div>
        </section>
      </main>
