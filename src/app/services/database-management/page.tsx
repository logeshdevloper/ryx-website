...
export const metadata: Metadata = {
  ...
  description: "Reliable database management for high-performance applications.",
};
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto mb-8">
                At RYX, we specialize in building, optimizing, and maintaining Supabase, MySQL, and PostgreSQL databases that scale with your business.
              </p>
